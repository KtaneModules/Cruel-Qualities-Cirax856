...
public static class ReflectionHelper
{
    ...
    public static Type FindType(string fullName, string assemblyName = null)
    {
        return AppDomain.CurrentDomain.GetAssemblies().SelectMany(a => a.GetSafeTypes()).FirstOrDefault(t =>
            t.FullName != null && t.FullName.Equals(fullName) &&
            (assemblyName == null || t.Assembly.GetName().Name.Equals(assemblyName)));
    }
...
#pragma warning restore 0038
    ...
    public static T GetValue<T>(this Type type, string member, object target = null)
    {
        ...
        return (T)(fieldMember != null ? fieldMember.GetValue(target) :
            propertyMember != null ? propertyMember.GetValue(target, null) : default(T));
    }
...
#pragma warning disable 0034, 0034, 1244
        return member != null ? (T)member.Invoke(target, arguments) : default(T);
#pragma warning restore 0034, 0034, 1244
    }
